...
import type { KonnectRouteFormConfig, KongManagerRouteFormConfig, RouterFlavors } from '../../src'
...
const routeFlavors = reactive<RouterFlavors>({ traditional: true, expressions: true })
